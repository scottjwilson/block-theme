...
<div class="wp-block-group has-cream-background-color has-background" style="padding-top:var(--wp--preset--spacing--3xl);padding-right:var(--wp--preset--spacing--xl);padding-bottom:var(--wp--preset--spacing--3xl);padding-left:var(--wp--preset--spacing--xl)">
    ...
    <div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--2xl)">
        ...
        <h2 class="wp-block-heading has-text-align-center has-navy-color has-text-color" style="font-size:clamp(2rem, 1.5rem + 2.5vw, 3rem)">The faces behind<br><em style="color:#4a7c8c;">our mission</em></h2>
        <!-- /wp:heading -->
    </div>
    <!-- /wp:group -->
    ...
    <div class="wp-block-columns">
        ...
        <div class="wp-block-column" style="flex-basis:60%">
            <!-- wp:group {"style":{"border":{"radius":"12px"},"spacing":{"padding":{"top":"0","bottom":"0","left":"0","right":"0"}}},"backgroundColor":"white","layout":{"type":"default"}} -->
            <div class="wp-block-group has-white-background-color has-background" style="border-radius:12px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
                <!-- wp:columns {"style":{"spacing":{"blockGap":{"left":"0"}}}} -->
                <div class="wp-block-columns">
                    <!-- wp:column -->
                    <div class="wp-block-column">
                        <!-- wp:html -->
                        <div style="height:100%;min-height:400px;background:linear-gradient(135deg, #e8e0d4 0%, #f0ebe3 100%);display:flex;align-items:center;justify-content:center;text-align:center;padding:2rem;color:#9a918a;font-size:0.9375rem;font-style:italic;border-radius:12px 0 0 12px;">
                            <span>Portrait: Marcus, program graduate</span>
                        </div>
                        <!-- /wp:html -->
                    </div>
                    <!-- /wp:column -->
                    ...
                    <div class="wp-block-column">
                        ...
                        <div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--lg);padding-right:var(--wp--preset--spacing--lg);padding-bottom:var(--wp--preset--spacing--lg);padding-left:var(--wp--preset--spacing--lg)">
                            ...
                            <h3 class="wp-block-heading has-navy-color has-text-color" style="font-size:clamp(1.25rem, 1.1rem + 0.75vw, 1.5rem)">"Harbor Light gave me permission to dream again"</h3>
                            <!-- /wp:heading -->

                            <!-- wp:paragraph {"style":{"typography":{"fontSize":"0.9375rem"}},"textColor":"charcoal-light"} -->
                            <p class="has-charcoal-light-color has-text-color" style="font-size:0.9375rem">After losing his job and apartment in 2023, Marcus found his way to our Beacon Academy. Eighteen months later, he's a certified IT technician with a stable apartment and plans to start community college.</p>
                            <!-- /wp:paragraph -->

                            <!-- wp:paragraph {"style":{"typography":{"fontWeight":"600","fontSize":"0.9375rem"}}} -->
                            <p style="font-size:0.9375rem;font-weight:600"><a href="#" style="color:#1a2744;text-decoration:none;">Read Marcus's story</a></p>
                            <!-- /wp:paragraph -->
                        </div>
                        <!-- /wp:group -->
                    </div>
        ...
        <div class="wp-block-column" style="flex-basis:40%">
            ...
            <div class="wp-block-group">
                ...
                <div class="wp-block-group has-white-background-color has-background" style="border-radius:12px">
                    <!-- wp:html -->
                    <div style="height:160px;background:linear-gradient(135deg, #e8e0d4 0%, #f0ebe3 100%);display:flex;align-items:center;justify-content:center;text-align:center;padding:1rem;color:#9a918a;font-size:0.875rem;font-style:italic;border-radius:12px 12px 0 0;">
                    ...
                    <div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--md);padding-right:var(--wp--preset--spacing--md);padding-bottom:var(--wp--preset--spacing--md);padding-left:var(--wp--preset--spacing--md)">
                        ...
                        <!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"clamp(1.125rem, 1rem + 0.5vw, 1.25rem)"}},"textColor":"navy"} -->
                        <h3 class="wp-block-heading has-navy-color has-text-color" style="font-size:clamp(1.125rem, 1rem + 0.5vw, 1.25rem)">A fresh start for the Rivera family</h3>
                        <!-- /wp:heading -->

                        <!-- wp:paragraph {"style":{"typography":{"fontWeight":"600","fontSize":"0.9375rem"}}} -->
                        <p style="font-size:0.9375rem;font-weight:600"><a href="#" style="color:#1a2744;text-decoration:none;">Read their story</a></p>
                        <!-- /wp:paragraph -->
                    </div>
                    <!-- /wp:group -->
                </div>
                ...
                <div class="wp-block-group has-white-background-color has-background" style="border-radius:12px">
                    ...
                    <div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--md);padding-right:var(--wp--preset--spacing--md);padding-bottom:var(--wp--preset--spacing--md);padding-left:var(--wp--preset--spacing--md)">
                        ...
                        <!-- wp:heading {"level":3,"style":{"typography":{"fontSize":"clamp(1.125rem, 1rem + 0.5vw, 1.25rem)"}},"textColor":"navy"} -->
                        <h3 class="wp-block-heading has-navy-color has-text-color" style="font-size:clamp(1.125rem, 1rem + 0.5vw, 1.25rem)">Why I tutor every Saturday</h3>
                        <!-- /wp:heading -->

                        <!-- wp:paragraph {"style":{"typography":{"fontWeight":"600","fontSize":"0.9375rem"}}} -->
                        <p style="font-size:0.9375rem;font-weight:600"><a href="#" style="color:#1a2744;text-decoration:none;">Read James's story</a></p>
                        <!-- /wp:paragraph -->
                    </div>
                    <!-- /wp:group -->
                </div>
