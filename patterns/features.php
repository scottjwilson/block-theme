...
<div class="wp-block-group has-mist-light-background-color has-background" style="padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--40)">
	...
	<div class="wp-block-group" style="margin-bottom:var(--wp--preset--spacing--50)">
		...
		<!-- wp:heading {"textAlign":"center","style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"2rem"}},"textColor":"harbor"} -->
		<h2 class="wp-block-heading has-text-align-center has-harbor-color has-text-color" style="font-size:2rem;font-style:normal;font-weight:700">Make a difference today</h2>
		<!-- /wp:heading -->
	</div>
	<!-- /wp:group -->
	...
	<div class="wp-block-columns">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group has-harbor-background-color has-background" style="border-radius:12px;min-height:100%;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--30)">
				...
				<div class="wp-block-group">
					<!-- wp:html -->
					<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#C9A227" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><line x1="19" y1="8" x2="19" y2="14"></line><line x1="22" y1="11" x2="16" y2="11"></line></svg>
					<!-- /wp:html -->

					<!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"1.1rem"}},"textColor":"canvas"} -->
					<h3 class="wp-block-heading has-canvas-color has-text-color" style="font-size:1.1rem;font-style:normal;font-weight:700">Become a volunteer</h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
				...
				<div class="wp-block-buttons">
					<!-- wp:button {"backgroundColor":"primary","textColor":"canvas","style":{"border":{"radius":"50px"},"typography":{"fontSize":"0.875rem"},"spacing":{"padding":{"top":"0.6rem","bottom":"0.6rem","left":"1.25rem","right":"1.25rem"}},"elements":{"link":{"color":{"text":"var:preset|color|canvas"}}}}} -->
					<div class="wp-block-button" style="font-size:0.875rem"><a class="wp-block-button__link has-canvas-color has-primary-background-color has-text-color has-background has-link-color wp-element-button" style="border-radius:50px;padding-top:0.6rem;padding-right:1.25rem;padding-bottom:0.6rem;padding-left:1.25rem">Join Us Now</a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group has-primary-background-color has-background" style="border-radius:12px;min-height:100%;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--30)">
				...
				<div class="wp-block-group">
					<!-- wp:html -->
					<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="5"></circle><path d="M12 13v8"></path><path d="M8 21h8"></path><path d="M12 3v2"></path></svg>
					<!-- /wp:html -->

					<!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"1.1rem"}},"textColor":"canvas"} -->
					<h3 class="wp-block-heading has-canvas-color has-text-color" style="font-size:1.1rem;font-style:normal;font-weight:700">Donate to support</h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
				...
				<!-- wp:buttons -->
				<div class="wp-block-buttons">
					<!-- wp:button {"backgroundColor":"canvas","textColor":"primary","style":{"border":{"radius":"50px"},"typography":{"fontSize":"0.875rem"},"spacing":{"padding":{"top":"0.6rem","bottom":"0.6rem","left":"1.25rem","right":"1.25rem"}},"elements":{"link":{"color":{"text":"var:preset|color|primary"}}}}} -->
					<div class="wp-block-button" style="font-size:0.875rem"><a class="wp-block-button__link has-primary-color has-canvas-background-color has-text-color has-background has-link-color wp-element-button" style="border-radius:50px;padding-top:0.6rem;padding-right:1.25rem;padding-bottom:0.6rem;padding-left:1.25rem">Donate Now</a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-cover" style="border-radius:12px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--30);min-height:100%"><span aria-hidden="true" class="wp-block-cover__background has-harbor-background-color has-background-dim-60 has-background-dim"></span><div class="wp-block-cover__inner-container">
				...
				<div class="wp-block-group">
					<!-- wp:html -->
					<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#C9A227" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
					<!-- /wp:html -->

					<!-- wp:heading {"level":3,"style":{"typography":{"fontStyle":"normal","fontWeight":"700","fontSize":"1.1rem"}},"textColor":"canvas"} -->
					<h3 class="wp-block-heading has-canvas-color has-text-color" style="font-size:1.1rem;font-style:normal;font-weight:700">Become a partner</h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
				...
				<div class="wp-block-buttons">
					<!-- wp:button {"backgroundColor":"primary","textColor":"canvas","style":{"border":{"radius":"50px"},"typography":{"fontSize":"0.875rem"},"spacing":{"padding":{"top":"0.6rem","bottom":"0.6rem","left":"1.25rem","right":"1.25rem"}},"elements":{"link":{"color":{"text":"var:preset|color|canvas"}}}}} -->
					<div class="wp-block-button" style="font-size:0.875rem"><a class="wp-block-button__link has-canvas-color has-primary-background-color has-text-color has-background has-link-color wp-element-button" style="border-radius:50px;padding-top:0.6rem;padding-right:1.25rem;padding-bottom:0.6rem;padding-left:1.25rem">Learn More</a></div>
					<!-- /wp:button -->
				</div>
				<!-- /wp:buttons -->
